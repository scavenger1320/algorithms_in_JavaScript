// create a new Singly Linked List (SLL)
var SLL = function(){
	this.head = null; // a new SLL only has a head that points to null until we start adding nodes
}

// create a SLL node object that will be inserted into an SLL
var SLLNode = function(value){ // function takes in a value
	this.val = value; // set the node's value to the passed in value
	this.next = null; // set the pointer to the next node as null
}
...
module.exports = SLL; // this allows us to export the SLL class to other files for them to use
// we'll need the SLL and related functions here to create our test cases
// in other singly linked list files
